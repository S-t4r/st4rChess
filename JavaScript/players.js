export class Player {
    ...
    createPlayerDOM() {
        ...
        // Styling.
        player.css({display: 'block', textAlign: 'center', padding: '0rem 2rem', width: '70vh',
            margin: '0.5rem', background: '#EE11AA', border: '1px solid black', borderRadius: '1rem'});

        capturedPieces.css({display: 'flex', flexDirection: 'row', padding: '1rem 2rem', 
            background: '#AA11AA', border: '1px solid black', borderRadius: '1rem'});
