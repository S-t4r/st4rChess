export class Player {
    ...
    createPlayerDOM() {
        ...
        // P element.
        capturedPieces.html(`<p>score: ${this.score}</p>`);
        
        // Styling.
        player.css({display: 'grid', textAlign: 'center', padding: '1rem 2rem',
            margin: '1rem', background: '#EE11AA', border: '1px solid black', borderRadius: '1rem'});
        capturedPieces.css({padding: '1rem 2rem',  background: '#AA11AA', border: '1px solid black', borderRadius: '1rem'});
